...
var InputCombo = /** @class */ (function () {
    function InputCombo(el, domHandler, renderer, cd, objectUtils, zone) {
        ...
        this.inputcomboIcon = 'pi pi-caret-down';
        ...
        switch (event.toState) {
            case 'visible':
                ...
                if (this.options && this.options.length) {
                    var selectedListItem = this.domHandler.findSingle(this.itemsWrapper, '.ui-inputcombo-item.ui-state-highlight');
                    if (selectedListItem) {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], InputCombo.prototype, "inputcomboIcon", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
