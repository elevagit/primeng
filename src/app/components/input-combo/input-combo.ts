...
export const DROPDOWN_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => InputCombo),
  multi: true
};
...
export class InputCombo implements OnInit,AfterViewInit,AfterContentInit,AfterViewChecked,OnDestroy,ControlValueAccessor {
...
@NgModule({
    ...
    exports: [InputCombo,SharedModule],
